...
1.  Read in the file `../data/california_counties/california_counties.shp`
...
For example, we could look at the multi-racial population *per square mile* within a county:
...
Now it's your turn! Using the method shown above, plot the distribution of a **different** race group from the `counties` dataset using all three methods: 1) count, 2) density, and 3) percent.
